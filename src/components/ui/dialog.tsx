...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        // No backdrop blur. It is the one effect here the compositor has to
        // redo for the whole viewport on every frame of the fade, and on a
        // phone that is what a dialog that "feels heavy" is made of. The scrim
        // is darkened a little to do the separating the blur was helping with.
